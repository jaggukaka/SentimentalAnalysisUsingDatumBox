 ...
 */
public class TextClassiferExtendend extends BaseWrapper<extended.TextClassiferExtendend.ModelParameters, extended.TextClassiferExtendend.TrainingParameters> {
    
    public static final String SHORT_METHOD_NAME = "TxtCl";
    private int rawFeaturesSize;

    public FeatureSelection getFeatureSelection() {
        return featureSelection;
    }

    public void setRawFeaturesSize(int rawFeaturesSize) {
        this.rawFeaturesSize = rawFeaturesSize;
    }

    public int getRawFeaturesSize() {
        return rawFeaturesSize;
    }
    ...
    public TextClassiferExtendend(String dbName) {
        super(dbName, extended.TextClassiferExtendend.ModelParameters.class, extended.TextClassiferExtendend.TrainingParameters.class);
    }
    ...
    public void train(Map<Object, URI> dataset) {
        ...
        extended.TextClassiferExtendend.TrainingParameters trainingParameters = knowledgeBase.getTrainingParameters();
        ...
        if (selectFeatures) {
            ...
            setRawFeaturesSize(trainingDataset.getColumnSize());
